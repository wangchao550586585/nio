 ...
 * getUnsignedByte()返回一个short类型,getUnsignedShort( )  返回一个int类型，而getUnsignedInt()返回一个long型。
...
public class D_Unsigned {
    ...
    public static void main(String[] argv)
        ...
        buffer.clear();
        D_Unsigned.putUnsignedByte(buffer, 255);
        D_Unsigned.putUnsignedByte(buffer, 128);
        D_Unsigned.putUnsignedShort(buffer, 0xcafe);
        D_Unsigned.putUnsignedInt(buffer, 0xcafebabe);
